...
import { View, Text, StyleSheet, Image, TouchableWithoutFeedback, Linking, Clipboard } from 'react-native';
      ...
      <Flex justify="between" style={{ flex: 1 }}>
        ...
        <Flex>
          ...
          <View style={{ marginRight: 10 }}>
            ...
            >
              <Image style={styles.content.linkedin} source={require('asset/project/detail/mobile.png')} />
            </TouchableWithoutFeedback>
          </View>
        )}
          {!!wechat && (
          <View style={{ marginRight: 10 }}>
            ...
            >
              <Image style={styles.content.linkedin} source={require('asset/project/detail/wechat.png')} />
            </TouchableWithoutFeedback>
          </View>
        )}
          {!!linkedIn_url && (
